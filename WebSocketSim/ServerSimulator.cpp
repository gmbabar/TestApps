...
// public:
//     explicit Listener(net::io_context &ctx, tcp::endpoint endpoint) : ctx_(ctx), acceptor_(ctx)
//     {
//         beast::error_code ec;
...
//     void DoAccept()
//     {
//         acceptor_.async_accept(net::make_strand(ctx_), beast::bind_front_handler(&Listener::AcceptHandler, shared_from_this()));
//     }

//     void AcceptHandler(const beast::error_code &ec, size_t bytesRead)
//     {
//         if(ec)
//         {
...
// class WebServer{
// public:
//     WebServer(net::io_context &ctx, std::string host = "127.0.0.1", short port = 9443) : ctx_(ctx), ws_(ctx_),
//     endpoint(boost::asio::ip::make_address(host), port)
//     {
//         ws_.next_layer().bind(endpoint);
//     }

//     void Accept(const beast::error_code &ec)
//     {
//         ws_.accept(ec);
//     }
