...
void ParseOpenOrders(const std::string& jsonString)
{
    ptree pt;
    ...
    {
        const auto symbol = order.second.get<std::string>("symbol");
        const auto source = order.second.get<std::string>("source");
        const auto price = order.second.get<std::string>("price");
        const auto createdAt = order.second.get<long>("created-at");
        const auto amount = order.second.get<std::string>("amount");
        const auto accountId = order.second.get<int>("account-id");
        const auto filledCashAmount = order.second.get<std::string>("filled-cash-amount");
        const auto clientOrderId = order.second.get<std::string>("client-order-id");
        const auto filledAmount = order.second.get<std::string>("filled-amount");
        const auto filledFees = order.second.get<std::string>("filled-fees");
        const auto id = order.second.get<long>("id");
        const auto state = order.second.get<std::string>("state");
        const auto type = order.second.get<std::string>("type");
        ...
        std::cout << "Filled Cash Amount: " << filledCashAmount << std::endl;
        std::cout << "Client Order ID: " << clientOrderId << std::endl;
        std::cout << "Filled Amount: " << filledAmount << std::endl;
        std::cout << "Filled Fees: " << filledFees << std::endl;
...
// const std::string aApiPort="443";
        ...
        req_.target("/v1/order/openOrders");
