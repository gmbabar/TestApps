...
****/
inline std::string FormatExchangeCapabilities(std::ostringstream &oss, 
...
int main() {
    ...
    std::ostringstream oss;
    std::string json = FormatExchangeCapabilities(oss, "BTFX", false, true, false, true);
